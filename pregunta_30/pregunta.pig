...
trans1 = FOREACH datos GENERATE ToString(col4, 'yyyy-MM-dd') AS fecha, ToString(col4, 'dd,d') AS dia, ToString(col4, 'EEE') AS nombre_pdia, ToString(col4, 'EEEE') AS nombre_dia;;
